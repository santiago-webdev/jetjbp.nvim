...
vim.api.nvim_set_hl(0, 'EndOfBuffer', { bg = jbp.clr_25, fg = jbp.clr_85 })
...
vim.api.nvim_set_hl(0, 'ModeMsg', { bg = jbp.clr_65, fg = jbp.clr_300 })
vim.api.nvim_set_hl(0, 'MsgArea', { bg = jbp.clr_55, fg = jbp.clr_300 }) -- Area for messages and cmdline, `/` and `:`.
...
vim.api.nvim_set_hl(0, 'Pmenu', { bg = jbp.clr_40, fg = jbp.clr_95 })
...
vim.api.nvim_set_hl(0, 'QuickFixLine', { bg = jbp.clr_orange_70, fg = jbp.clr_95, nocombine = true })
-- Any special symbol, sometimes it could be {} curly braces/brackets and also `NOTE:`
vim.api.nvim_set_hl(0, 'Special', { fg = jbp.clr_orange_70, undercurl = false })
...
vim.api.nvim_set_hl(0, 'Whitespace', { fg = jbp.clr_50 }) -- Listchars.
...
vim.api.nvim_set_hl(0, 'IncSearch', { bg = jbp.clr_goaway_green, fg = jbp.clr_05 })
...
vim.api.nvim_set_hl(0, 'Substitute', { bg = jbp.clr_purple_50, fg = jbp.clr_05 })
...
vim.api.nvim_set_hl(0, '@punctuation.bracket.svelte', { fg = jbp.mauve }) -- () Brackets, braces, parentheses, etc.
-- Punctuation delimiters: Periods, commas, semicolons, etc.
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { link = 'Delimiter' })
vim.api.nvim_set_hl(0, '@lsp.typemod.variable.definition', { link = '@punctuation.delimiter' })
-- Punctuation delimiters: Periods, commas, semicolons, etc.
vim.api.nvim_set_hl(0, '@punctuation.delimiter.markdown_inline', { fg = jbp.clr_purple_50 })

-- Special punctuation that doesn't fit into the previous categories.
vim.api.nvim_set_hl(0, '@punctuation.special', { fg = jbp.clr_green_50 })
...
vim.api.nvim_set_hl(0, '@type.qualifier', { fg = jbp.clr_blue_40 })
...
vim.api.nvim_set_hl(0, '@variable.builtin', { link = '@constant.builtin' })
-- Variable names defined by the language: `this` or `self` in Javascript and Python.
vim.api.nvim_set_hl(0, '@variable.builtin.python', { fg = jbp.clr_goaway_green })

-- Annotations that can be attached to the code to denote some kind of meta information. e.g. C++/Dart attributes.
vim.api.nvim_set_hl(0, '@attribute', { fg = jbp.clr_red_50 })
...
vim.api.nvim_set_hl(0, '@string.escape', { fg = jbp.clr_orange_70 })
...
vim.api.nvim_set_hl(0, 'Constant', { fg = jbp.clr_red_40 })
...
vim.api.nvim_set_hl(0, '@constant', { fg = jbp.clr_red_50 })
-- built-in constant values: `nil` in Lua, undefined and null in Javascript.
vim.api.nvim_set_hl(0, '@constant.builtin', { fg = jbp.clr_red_40 })
vim.api.nvim_set_hl(0, '@constant.macro', { fg = jbp.clr_purple_50 }) -- Constants defined by macros: `NULL` in C.
vim.api.nvim_set_hl(0, '@lsp.type.macro', { fg = jbp.clr_purple_40 }) -- Constants defined by macros: `NULL` in C.
...
vim.api.nvim_set_hl(0, '@text.note', { fg = jbp.clr_blue_40 })
...
vim.api.nvim_set_hl(0, '@text.strong', { bold = true, fg = jbp.clr_yellow })
-- FIXME Text representation of a danger note.
vim.api.nvim_set_hl(0, '@text.emphasis', { italic = true, fg = jbp.clr_goaway_green })
-- FIXME Text representation of a danger note.
vim.api.nvim_set_hl(0, '@text.strike', { strikethrough = true, fg = jbp.clr_blue_40 })
...
vim.api.nvim_set_hl(0, 'Title', { fg = jbp.clr_orange_50 })
...
vim.api.nvim_set_hl(0, '@text.reference', { fg = jbp.clr_red_40 })
...
-- vim.api.nvim_set_hl(0, 'TSEnvironmentName', {})
...
vim.api.nvim_set_hl(0, '@function.macro', { fg = jbp.clr_purple_50 })
...
vim.api.nvim_set_hl(0, 'Include', { fg = jbp.clr_blue_40 })
...
vim.api.nvim_set_hl(0, '@keyword.function', { fg = jbp.clr_purple_50, italic = true })
-- Unary and binary operators that are English words: `and`, `or` in Python and Lua; `sizeof` in C.
vim.api.nvim_set_hl(0, '@keyword.operator', { fg = jbp.mauve })
...
vim.api.nvim_set_hl(0, 'LspReferenceRead', { fg = jbp.clr_10, bg = jbp.clr_200 })
...
vim.api.nvim_set_hl(0, 'LspInlayHint', { fg = jbp.clr_75 })
...
vim.api.nvim_set_hl(0, 'IndentBlanklineChar', { fg = jbp.clr_45 })
