...
vim.api.nvim_set_hl(0, '@parameter', { fg = jbp.clr_red_80 }) -- Parameters of a function.
...
vim.api.nvim_set_hl(0, 'Float', { fg = jbp.clr_red_50 }) -- A floating point constant: 2.3e10
...
vim.api.nvim_set_hl(0, '@type.definition', { fg = jbp.clr_blue }) -- Type definitions, e.g. `typedef` in C.
vim.api.nvim_set_hl(0, '@type.qualifier', { fg = jbp.clr_blue }) -- Qualifiers on types, e.g. `const` or `volatile` in C or `mut` in Rust.
...
-- hlgr constants
vim.api.nvim_set_hl(0, 'Constant', { fg = jbp.clr_red_50 }) -- NOTE: to self, this changes the name in -> TODO(santigo-zero):
vim.api.nvim_set_hl(0, '@constant', { fg = jbp.clr_red_80 }) -- Constants identifiers. These might not be semantically constant.  E.g. uppercase variables in Python and emmylua annotations in lua
vim.api.nvim_set_hl(0, '@constant.builtin', { fg = jbp.clr_red_50 }) -- built-in constant values: `nil` in Lua, undefined and null in Javascript.
vim.api.nvim_set_hl(0, '@constant.macro', { fg = jbp.clr_red_50 }) -- Constants defined by macros: `NULL` in C.
...
vim.api.nvim_set_hl(0, 'Error', { fg = jbp.clr_red_50 }) -- Any erroneous construct
...
vim.api.nvim_set_hl(0, '@text.note', { fg = jbp.clr_blue }) -- NOTE: INUPPERCASE: -- The italic = true affects @todo for some reason
...
vim.api.nvim_set_hl(0, '@define', { fg = jbp.clr_blue }) -- Preprocessor #define statements.
vim.api.nvim_set_hl(0, '@tag', { fg = jbp.clr_purple_50 }) -- Tags like HTML tag names.
vim.api.nvim_set_hl(0, '@tag.attribute', { fg = jbp.clr_azure }) -- HTML tag attributes like classes and ids
...
vim.api.nvim_set_hl(0, '@text.reference', { fg = jbp.clr_red_50 }) -- Help pages: Footnotes, text references, citations, etc.
...
-- hlgr zsh
vim.api.nvim_set_hl(0, 'zshSubst', { fg = jbp.clr_red_50 })
vim.api.nvim_set_hl(0, 'zshDeref', { fg = jbp.clr_red_50 })
...
-- hlgr functions
vim.api.nvim_set_hl(0, 'Function', { fg = jbp.clr_purple_70 }) -- Function name (also: methods for classes)
...
vim.api.nvim_set_hl(0, '@function.call', { fg = jbp.clr_blue }) -- Function calls.
vim.api.nvim_set_hl(0, '@function.builtin', { fg = jbp.clr_purple_70 }) -- Built-in functions: `print` in Lua.

vim.api.nvim_set_hl(0, 'Include', { fg = jbp.clr_blue }) -- import { ... } from '...' or from ... import ... or #include in C
...
vim.api.nvim_set_hl(0, 'Macro', { fg = jbp.clr_red_50 })
...
vim.api.nvim_set_hl(0, 'Operator', { fg = jbp.clr_red_50 }) -- "sizeof", "+", "*"
...
vim.api.nvim_set_hl(0, 'DiagnosticError', { fg = jbp.clr_red_50 })
vim.api.nvim_set_hl(0, 'DiagnosticHint', { fg = jbp.clr_blue })
vim.api.nvim_set_hl(0, 'DiagnosticInfo', { fg = jbp.clr_purple_50 })
vim.api.nvim_set_hl(0, 'DiagnosticWarn', { fg = jbp.clr_yellow })

vim.api.nvim_set_hl(0, 'DiagnosticVirtualTextError', { bg = jbp.clr_bg_red_50, fg = jbp.clr_red_50 })
vim.api.nvim_set_hl(0, 'DiagnosticVirtualTextHint', { bg = jbp.clr_bg_blue, fg = jbp.clr_blue })
...
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineError', { undercurl = true, sp = jbp.clr_red_50 })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineHint', { undercurl = true, sp = jbp.clr_blue })
...
vim.api.nvim_set_hl(0, 'GitSignsAdd', { fg = jbp.clr_blue })
vim.api.nvim_set_hl(0, 'GitSignsDelete', { fg = jbp.clr_red_70 })
